-- =============================================================================
-- SECURITY FIX: Function Search Path Mutable - Complete Fix (Dependency Safe)
-- =============================================================================
-- 
-- FUNCTIONS TO FIX:
...
DROP FUNCTION IF EXISTS public.update_campaign_analytics() CASCADE;
...
DROP FUNCTION IF EXISTS public.update_down_payment_progress() CASCADE;
...
-- This function might not have dependencies, but use CASCADE to be safe
DROP FUNCTION IF EXISTS public.select_optimal_contract_template(TEXT, TEXT, TEXT) CASCADE;
...
-- This function might not have dependencies, but use CASCADE to be safe
DROP FUNCTION IF EXISTS public.calculate_legal_risk_score(TEXT, TEXT, TEXT) CASCADE;
...
DROP FUNCTION IF EXISTS public.trigger_contract_generation() CASCADE;
...
-- Check that triggers are properly recreated
SELECT 
  schemaname,
  tablename,
  triggername,
...
WHERE triggername IN (
  'trigger_update_campaign_analytics',
  'trigger_update_down_payment_progress',
  'trigger_contract_generation'
)
