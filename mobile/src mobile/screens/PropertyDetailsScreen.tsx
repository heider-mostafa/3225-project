  ...
  const loadPropertyDetails = async () => {
    try {
      ...
      if (response.success && response.data) {
        ...
        if ((response.data as any).property_appraisals && (response.data as any).property_appraisals.length > 0) {
          const appraisal = (response.data as any).property_appraisals[0]; // Get the first appraisal
