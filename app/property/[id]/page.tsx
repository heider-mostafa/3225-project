  ...
  useEffect(() => {
    ...
    const fetchPropertyBrokers = async () => {
      try {
        ...
        console.log('🏢 Fetching brokers for property:', resolvedParams.id)
        
        const response = await fetch(`/api/properties/${resolvedParams.id}/brokers`)
