...
${t('mortgageCalculator.appCredit')}`
  ...
  return (
    <div className={`bg-white rounded-lg border shadow-sm ${className}`}>
      {/* Consistent Header with CardTitle styling */}
      <div className="flex flex-col space-y-1.5 p-6">
        ...
        <p className="text-sm text-muted-foreground">{t('mortgageCalculator.subtitle')}</p>
      </div>
          ...
          <>
            ...
            <div className="mb-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-lg font-semibold text-slate-800">{t('mortgageCalculator.propertyLoanDetails')}</h3>
              </div>
