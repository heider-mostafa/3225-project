-- Basic Egyptian Real Estate Sample Data
-- This script populates the database with properties and photos only
...
SELECT 
  'Database successfully seeded with properties and photos!' as message,
