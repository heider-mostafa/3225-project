-- Fixed Egyptian Real Estate Sample Data with proper UUIDs
...
WITH property_data AS (
  ...
  UNION ALL SELECT 
    gen_random_uuid(), 'Modern Penthouse in Hyde Park',
    ...
    12000000, 4, 3, 3200, 'Hyde Park Compound', 'New Cairo', 'Cairo Governorate', '11835', 'penthouse', 'for_sale', 2
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Elegant Villa in Beverly Hills',
    ...
    8500000, 5, 4, 4800, 'Beverly Hills Compound', 'Sheikh Zayed', 'Giza Governorate', '12588', 'villa', 'for_sale', 3
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Contemporary Villa in Allegria',
    ...
    15000000, 4, 3, 3800, 'Allegria Golf Resort', 'Sheikh Zayed', 'Giza Governorate', '12588', 'villa', 'for_sale', 4
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Classic Apartment in Zamalek',
    ...
    3200000, 2, 2, 1400, '15 Shagaret El Dor Street', 'Zamalek', 'Cairo Governorate', '11211', 'apartment', 'for_sale', 5
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Family Townhouse in Dreamland',
    ...
    5200000, 3, 2, 2400, 'Dreamland Golf Resort', '6th of October', 'Giza Governorate', '12566', 'townhouse', 'for_sale', 6
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Beachfront Villa in Marina',
    ...
    18000000, 4, 4, 4200, 'Marina Resort', 'Marina', 'North Coast', '12345', 'villa', 'for_sale', 7
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Modern Apartment in Capital Gardens',
    ...
    2800000, 2, 2, 1300, 'Capital Gardens Compound', 'New Administrative Capital', 'Cairo Governorate', '11865', 'apartment', 'for_sale', 8
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Seafront Apartment in Alexandria',
    ...
    4200000, 3, 2, 1800, '25 Corniche Road', 'Sidi Bishr', 'Alexandria Governorate', '21599', 'apartment', 'for_sale', 9
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Prime Retail Space in Mall of Egypt',
    ...
    8000000, NULL, NULL, 1500, 'Mall of Egypt', 'Sheikh Zayed', 'Giza Governorate', '12588', 'commercial', 'for_sale', 10
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Affordable Family Apartment in Maadi',
    ...
    2100000, 2, 1, 1100, '45 Road 9', 'Maadi', 'Cairo Governorate', '11431', 'apartment', 'for_sale', 11
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Modern Studio in Downtown Cairo',
    ...
    850000, 1, 1, 450, '12 Tahrir Square', 'Downtown', 'Cairo Governorate', '11511', 'studio', 'for_sale', 12
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Luxury Villa for Rent in Katameya Heights',
    ...
    80000, 5, 4, 5000, 'Katameya Heights', 'New Cairo', 'Cairo Governorate', '11835', 'villa', 'for_rent', 13
    
  UNION ALL SELECT 
    gen_random_uuid(), 'Furnished Apartment for Rent in Degla',
    ...
    25000, 3, 2, 1600, '8 Street 231', 'Degla', 'Cairo Governorate', '11431', 'apartment', 'for_rent', 14
),
...
-- Insert property photos using the actual property IDs
INSERT INTO property_photos (property_id, url, is_primary, order_index, created_at)
SELECT 
  p.id,
  CASE 
    WHEN p.sort_order = 1 THEN 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800'
    WHEN p.sort_order = 2 THEN 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800'
    WHEN p.sort_order = 3 THEN 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800'
    WHEN p.sort_order = 4 THEN 'https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=800'
    WHEN p.sort_order = 5 THEN 'https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=800'
    WHEN p.sort_order = 6 THEN 'https://images.unsplash.com/photo-1555636222-cae831e670b3?w=800'
    WHEN p.sort_order = 7 THEN 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800'
    WHEN p.sort_order = 8 THEN 'https://images.unsplash.com/photo-1571055058425-e12285c5b5ba?w=800'
    WHEN p.sort_order = 9 THEN 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=800'
    WHEN p.sort_order = 10 THEN 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=800'
    WHEN p.sort_order = 11 THEN 'https://images.unsplash.com/photo-1519833547608-93ce27ff7d51?w=800'
    WHEN p.sort_order = 12 THEN 'https://images.unsplash.com/photo-1569946709208-e9b97aa3b05e?w=800'
    WHEN p.sort_order = 13 THEN 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800'
...
-- Add second photos for each property
SELECT 
  p.id,
  CASE 
    WHEN p.sort_order = 1 THEN 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800'
    WHEN p.sort_order = 2 THEN 'https://images.unsplash.com/photo-1574362848149-11496d93a7c7?w=800'
    WHEN p.sort_order = 3 THEN 'https://images.unsplash.com/photo-1576941089067-2de3c901e126?w=800'
    WHEN p.sort_order = 4 THEN 'https://images.unsplash.com/photo-1505843513577-28017fcf54dd?w=800'
    WHEN p.sort_order = 5 THEN 'https://images.unsplash.com/photo-1560185008-b033106af5c3?w=800'
    WHEN p.sort_order = 6 THEN 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800'
    WHEN p.sort_order = 7 THEN 'https://images.unsplash.com/photo-1571055107559-3e67626fa8be?w=800'
    WHEN p.sort_order = 8 THEN 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=800'
    WHEN p.sort_order = 9 THEN 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=800'
    WHEN p.sort_order = 10 THEN 'https://images.unsplash.com/photo-1519833547608-93ce27ff7d51?w=800'
    WHEN p.sort_order = 11 THEN 'https://images.unsplash.com/photo-1569946709208-e9b97aa3b05e?w=800'
    WHEN p.sort_order = 12 THEN 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800'
    WHEN p.sort_order = 13 THEN 'https://images.unsplash.com/photo-1576941089067-2de3c901e126?w=800'
...
-- Insert sample inquiries using the actual property IDs
...
inquiry_data AS (
  SELECT 
    (SELECT id FROM sample_properties WHERE title = 'Luxury Apartment in Madinaty') as property_id,
    'Ahmed Hassan' as name,
    'ahmed.hassan@email.com' as email,
    '+201234567890' as phone,
    'I am interested in viewing this apartment. What is the availability for this weekend?' as message,
    'new' as status,
    'website' as source,
    1 as sort_order
    
  UNION ALL SELECT 
    (SELECT id FROM sample_properties WHERE title = 'Elegant Villa in Beverly Hills'),
    'Sarah Mohamed', 'sarah.mohamed@email.com', '+201987654321',
    'This villa looks perfect for my family. Can you provide more details about the compound amenities?',
    'contacted', 'website', 2
    
  UNION ALL SELECT 
    (SELECT id FROM sample_properties WHERE title = 'Classic Apartment in Zamalek'),
    'John Smith', 'john.smith@email.com', '+201555666777',
    'I am an expat looking for an apartment in Zamalek. Is this property still available?',
    'new', 'referral', 3
    
  UNION ALL SELECT 
    (SELECT id FROM sample_properties WHERE title = 'Beachfront Villa in Marina'),
    'Mona Abdel Rahman', 'mona.abdel@email.com', '+201444555666',
    'Interested in this beachfront villa for summer residence. What are the payment options?',
    'qualified', 'website', 4
    
  UNION ALL SELECT 
    (SELECT id FROM sample_properties WHERE title = 'Luxury Villa for Rent in Katameya Heights'),
    'Michael Johnson', 'michael.johnson@email.com', '+201333444555',
...
SELECT property_id, name, email, phone, message, status, source, NOW(), NOW()
FROM inquiry_data
