  ...
  en: {
    translation: {
      ...
      comingSoon: {
        ...
        afterLaunchPrice: 'After September 1st, this service costs 50,000 EGP. Reserve your FREE slot now or pay full price.',
...
if (resources.ar && resources.ar.translation) {
  ...
  (resources.ar.translation as any).comingSoon = {
    ...
    afterLaunchPrice: 'بعد 1 سبتمبر، ستكلف هذه الخدمة 50,000 جنيه مصري. احجز مكانك المجاني الآن أو ادفع السعر كاملاً.',
